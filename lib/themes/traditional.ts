...
// RESEARCH-BASED: Burgundy & Rose Gold (Sophisticated & Timeless)
export const traditionalTheme: KankotriTheme = {
  id: 'traditional',
  ...
  previewImage: '/previews/traditional.jpg',
  previewColors: ['#800020', '#D4AF37', '#FFF8E1'],
